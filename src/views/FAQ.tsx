...
export const FaqView = () => {
  return (
    <CanvasView>
      <CollapseContainer
        title="Does your summer program offer a 3-day option?"
        content={"We offer 3 days a week if a families schedule doesn't work full 4-day week during our summer program."}
      />
      <CollapseContainer
        title="Are children separated into age groups in your summer program?"
        content={"Yes. A majority of our students and campers are 6 and under and Montessori embraces mixed age classrooms."}
      />
      <CollapseContainer
      ...
      />
      <CollapseContainer
        title="What is your policy on disciplining children?"
        content={"The Montessori method focuses on teaching children consequences for their actions and emphasizes a strong, clear boundary along with guidance and responsibility for their actions."}
      />
    </CanvasView>
  )
}